...
``` r
## everything can help to manage the position of variable and only change what 
## is mentioned
...
select will output a DF, while pull will only pull a column in the form
of vector
...
used to add or change variables
...
``` r
## separate different new columns 
mutate(
  litters_df, 
